...
function spawnObjects() {
    // Check if the current time's minutes are divisible by 20
    ...
    function clearScene() {
        ...
        // Clear the array of draggable objects
        ...
        // Clear the array of shooting stars
        shootingStars.length = 0;
    }
    function checkAndClearScene() {
        const currentTime = new Date();
        const minutes = currentTime.getMinutes();
    ...
    if (selectedObject) {
        ...
        if (distance < distanceThreshold) {
            ...
            if (draggableObjects.length === 1) {
                ...
                window.location.href = 'https://chahe-dridi.github.io/nuit-info-easter-egg.github.io/test1/dark.html'; // Adjust the path based on your project structure
            }
...
// Function to check the time and clear the scene after 1 minute
...
spawnObjects();
launchFireworks();
setInterval(checkAndClearScene, 60000);
